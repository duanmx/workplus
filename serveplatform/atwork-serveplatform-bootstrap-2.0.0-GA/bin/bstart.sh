...
nohup java $JAVA_OPTS $JAVA_MEM_OPTS $JAVA_DEBUG_OPTS $JAVA_JMX_OPTS -cp $ETC_DIR:$LIB_JARS io.atwork.serveplatform.bootstrap.ServePlatformBootstrap >> $STDOUT_FILE 2>&1 &
